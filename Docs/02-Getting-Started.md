...
See if you can reproduce the included [demos](05-Demos.md) on your system, then dive into the [hardware](03-Hardware.md) and [software](04-Software.md) specifications to get a better sense of the tools OpenSwarm provides.
